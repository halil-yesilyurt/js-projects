...
function calculateWealth() {
  ...
  wealthEl.innerHTML = `<h3>Total Wealth: <strong>${generateMoney(wealth)}</strong></h3>`;
...
showMillionairesBtn.addEventListener('click', shohMillionaires);
// Calculate wealth
